...
import { A as Building2, M as ArrowRight, _ as MapPin, d as Phone, f as Package, l as ShieldCheck, t as X, u as Search, v as Mail } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/opportunities-BolvF3Ox.js
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								className: `mt-6 w-full inline-flex items-center justify-between rounded-xl px-4 py-2.5 text-sm font-semibold transition-all ${isOpen ? "bg-muted text-foreground" : "bg-gold text-[var(--gold-foreground)] hover:brightness-110 shadow-gold"}`,
