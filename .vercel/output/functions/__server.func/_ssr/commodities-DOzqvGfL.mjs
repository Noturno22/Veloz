...
import { B as ArrowRight, D as Handshake, J as ChartColumn, W as Earth, a as TrendingUp } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/commodities-DOzqvGfL.js
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					className: `px-4 py-2 text-xs font-bold uppercase tracking-wider rounded-lg whitespace-nowrap ${!activeTab ? "bg-gold text-[var(--gold-foreground)] shadow-gold" : "text-muted-foreground"}`,
