...
import { F as require_react, N as useRouter, P as require_jsx_runtime, c as HeadContent, d as createRouter, f as Outlet, g as Link, h as createRootRoute, l as useRouterState, m as createFileRoute, p as lazyRouteComponent, s as Scripts } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as useI18n, t as I18nProvider } from "./i18n-CPgOiQ-I.mjs";
import { C as Mail, I as Check, S as MapPin, b as MessageCircle, c as Sun, h as Phone, j as Facebook, k as Globe, r as Twitter, t as X, v as Moon, w as Linkedin, x as Menu } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-Df7qNniX.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-C4OT8JOo.css";
...
function LanguageSwitcher({ className = "" }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			type: "button",
			onClick: () => setOpen((v) => !v),
			className: "flex items-center gap-1.5 rounded-full border border-border bg-card px-3 h-9 text-sm font-medium text-foreground/80 hover:text-foreground hover:border-gold",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
					...
					children: NAV.map((item) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							className: `relative whitespace-nowrap text-[11px] font-semibold uppercase tracking-[0.18em] ${active ? "text-gold" : "text-foreground/70 hover:text-gold"}`,
...
function RootComponent() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThemeProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(I18nProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
var $$splitComponentImporter$9 = () => import("./partnership-U4YeOuIc.mjs");
var Route$9 = createFileRoute("/partnership")({
	head: () => ({
		meta: [
...
var $$splitComponentImporter$8 = () => import("./opportunities-DvOnWu2p.mjs");
var Route$8 = createFileRoute("/opportunities")({
	head: () => ({
		meta: [
...
var $$splitComponentImporter$7 = () => import("./insights-DNS9x384.mjs");
...
var $$splitComponentImporter$6 = () => import("./how-it-works-Bnc88h94.mjs");
var Route$6 = createFileRoute("/how-it-works")({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Conheça os nossos serviços de comércio global de commodities."
			},
			{
				property: "og:title",
				content: "Serviços — Veloz"
			},
			{
				property: "og:url",
...
var $$splitComponentImporter$5 = () => import("./dashboard-Dd2-DfN7.mjs");
...
var $$splitComponentImporter$4 = () => import("./contact-B22XpMWI.mjs");
var Route$4 = createFileRoute("/contact")({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Reach Veloz in London, UK. Phone, email."
			},
			{
				property: "og:title",
...
var $$splitComponentImporter$3 = () => import("./commodities-DiFULs6G.mjs");
...
var $$splitComponentImporter$2 = () => import("./admin-Co7cleAz.mjs");
...
var $$splitComponentImporter$1 = () => import("./about-DnJ3Gvwm.mjs");
...
var hero_trading_default = "/assets/hero-trading-ti3AzGyG.jpg";
var $$splitComponentImporter = () => import("./routes-CSpj994x.mjs");
...
var PartnershipRoute = Route$9.update({
	id: "/partnership",
	path: "/partnership",
	getParentRoute: () => Route$10
});
var OpportunitiesRoute = Route$8.update({
	id: "/opportunities",
	path: "/opportunities",
	getParentRoute: () => Route$10
});
