...
//#region node_modules/.nitro/vite/services/ssr/assets/insights-DN5Y12aM.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: [
				...
				className: `rounded-full px-4 py-2 text-sm font-medium border transition ${i === 0 ? "bg-[color:var(--navy)] text-white border-[color:var(--navy)]" : "border-border bg-white hover:border-gold"}`,
				children: t(c)
			}, c))
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
