...
import { n as useI18n } from "./i18n-CHWotKir.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DwFaU2Tv.js
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									...
									children: t("landing.signInEmail")
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									to: "/register",
									className: "text-gold font-semibold hover:underline transition-colors",
									children: t("landing.createAccount")
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-8 flex items-center justify-center gap-2 text-[10px] text-white/30 uppercase tracking-[0.2em] font-bold",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "h-3.5 w-3.5 text-gold" }), t("landing.secured")]
						})
					]
				})
			})
