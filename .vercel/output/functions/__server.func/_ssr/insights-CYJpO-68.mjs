...
//#region node_modules/.nitro/vite/services/ssr/assets/insights-CYJpO-68.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: [
				...
				className: `rounded-full px-4 py-2 text-sm font-medium border ${i === 0 ? "bg-[color:var(--brand-green)] text-white border-[color:var(--brand-green)]" : "border-border bg-card"}`,
				children: t(c)
			}, c))
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							className: "mt-2 font-display text-lg font-semibold text-[color:var(--navy)]",
